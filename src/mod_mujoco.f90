module mod_mujoco
  ...
  type(c_funptr) :: mjcb_passive
  type(c_funptr) :: mjcb_control
  type(c_funptr) :: mjcb_contactfilter
  type(c_funptr) :: mjcb_sensor
  type(c_funptr) :: mjcb_time
  type(c_funptr) :: mjcb_act_dyn
  type(c_funptr) :: mjcb_act_gain
  type(c_funptr) :: mjcb_act_bias
  ...
  !---------------------------------- Activation ----------------------------------------------------
    ...
    type(mjvGLCamera) function mjv_averageCamera(cam1, cam2) bind(c)
      import :: mjvGLCamera
      type(mjvGLCamera), value, intent(in) :: cam1, cam2
    ...
    subroutine mjv_updateScene(m, d, opt, pert, cam, cammask, scn) bind(c, name="mjv_updateScene")
